      ...
      <div className='newsline-slider__card swiper-slide'>
        <div className='newsline-card__container'>
          ...
          <div className='newsline-card__text'>
            <a href={articles.articles['url']} target='_blank' rel='noreferrer'>{articles.articles['title']}</a>
  ...
  return (
    <section className='newsline container'>
      <div className='newsline__text'>
        ...
        <p>We update the news feed every 15 minutes. You can learn more by clicking on the news you are interested
          in.</p>
      </div>
      <div className='newsline__slider swiper'>
        <div className='newsline__slider-line'>
          {news?.map((item: object, i) => (
            <NewsSliderCard articles={item} key={i} />
          ))}
        </div>
